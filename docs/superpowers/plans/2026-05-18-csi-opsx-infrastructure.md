...
| `tsup.config.ts` | Create | Build config + SKILL.md/command.md asset copy |
...
| `src/commands/explore/command.md` | Create | Slash command entry point (markdown asset) |
| `src/commands/propose/SKILL.md` | Create | Propose + harness delegation behavior (markdown asset) |
| `src/commands/propose/command.md` | Create | Slash command entry point (markdown asset) |
| `src/commands/apply/SKILL.md` | Create | Apply passthrough behavior (markdown asset) |
| `src/commands/apply/command.md` | Create | Slash command entry point (markdown asset) |
| `src/commands/archive/SKILL.md` | Create | Archive passthrough behavior (markdown asset) |
| `src/commands/archive/command.md` | Create | Slash command entry point (markdown asset) |
...
describe('install', () => {
  ...
  describe('installSkills', () => {
    it('copies SKILL.md to toolDir/skills/csi-opsx-{name}/SKILL.md', () => {
      ...
      expect(readFileSync(dest, 'utf8')).toBe('# Explore Skill');
    });
...
- Create: `src/commands/explore/command.md`
...
- [ ] **Step 2: Write src/commands/explore/command.md**

```markdown
Load and follow the skill at `csi-opsx-explore/SKILL.md` exactly.
```

- [ ] **Step 3: Commit**

```bash
git add src/commands/explore/SKILL.md src/commands/explore/command.md
...
- Create: `src/commands/apply/command.md`
- Create: `src/commands/archive/SKILL.md`
- Create: `src/commands/archive/command.md`
...
- [ ] **Step 2: Write src/commands/apply/command.md**

```markdown
Load and follow the skill at `csi-opsx-apply/SKILL.md` exactly.
```

- [ ] **Step 3: Write src/commands/archive/SKILL.md**
...
- [ ] **Step 4: Write src/commands/archive/command.md**

```markdown
Load and follow the skill at `csi-opsx-archive/SKILL.md` exactly.
```
...
- Create: `src/commands/propose/command.md`
...
- [ ] **Step 2: Write src/commands/propose/command.md**

```markdown
Load and follow the skill at `csi-opsx-propose/SKILL.md` exactly.
```
...
Expected: PASS — tool-detection (7), adapters (6), install (5) tests all pass.
...
- `dist/commands/explore/command.md` exists
- `dist/commands/propose/SKILL.md` exists
- `dist/commands/propose/command.md` exists
- `dist/commands/apply/SKILL.md` exists
- `dist/commands/apply/command.md` exists
- `dist/commands/archive/SKILL.md` exists
- `dist/commands/archive/command.md` exists
